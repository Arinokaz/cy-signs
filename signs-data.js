const allSigns = [
    ...
    },
    {
        ...
        "hint": {
            ...
            "uk": "Зупинка заборонена в будь-який час.",
            "el": "Απαγορεύεται η στάση ανά πάσα στιγμή.",
            "ru": "Остановка запрещена в любое время."
        },
        "explanation": {
            "en": "These lines depict the side of the carriageway where both parking and stopping are strictly prohibited at all times (24/7). This marking is used in high-traffic or high-risk areas to ensure the road remains completely clear for emergency vehicles and constant traffic flow.",
            "uk": "Ці лінії позначають край проїзної частини, де паркування та зупинка суворо заборонені в будь-який час (24/7). Ця розмітка використовується на ділянках з інтенсивним рухом або підвищеною небезпекою, щоб дорога залишалася вільною для спецтранспорту та постійного потоку машин.",
            "el": "Αυτές οι γραμμές οριοθετούν την άκρη του οδοστρώματος όπου η στάθμευση και η στάση απαγορεύονται αυστηρά καθ' όλη τη διάρκεια του 24ώρου. Αυτή η σήμανση χρησιμοποιείται σε περιοχές με αυξημένη κίνηση ή υψηλή επικινδυνότητα για τη διασφάλιση της ελεύθερης διέλευσης των οχημάτων.",
            "ru": "Эти линии обозначают край проезжей части, вдоль которого остановка и стоянка строго запрещены в любое время суток (24/7). Разметка используется на участках с интенсивным движением или повышенной опасностью, чтобы дорога всегда оставалась свободной для трафика и экстренных служб."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "Edge of road, no parking.",
            "uk": "Край дороги, паркування заборонено.",
            "el": "Άκρη δρόμου, απαγορεύεται η στάθμευση.",
            "ru": "Край дороги, парковка запрещена."
        },
        "explanation": {
            "en": "This line depicts the side of the carriageway where parking is strictly prohibited at all times. Its purpose is to keep the edge of the road clear to ensure a safe and unobstructed flow of traffic.",
            "uk": "Ця лінія позначає край проїзної частини, де паркування суворо заборонено в будь-який час. Вона допомагає тримати узбіччя вільним для забезпечення безпечного та безперешкодного руху транспорту.",
            "el": "Αυτή η γραμμή οριοθετεί την άκρη του οδοστρώματος όπου η στάθμευση απαγορεύεται αυστηρά ανά πάσα στιγμή. Σκοπός της είναι να διατηρεί την άκρη του δρόμου ελεύθερη για την ασφαλή και απρόσκοπτη κυκλοφορία.",
            "ru": "Эта линия обозначает край проезжей части, вдоль которого парковка строго запрещена в любое время. Она используется для того, чтобы край дороги оставался свободным, обеспечивая безопасность и бесперебойность движения."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "No parking at specific times.",
            "uk": "Паркування заборонено у визначений час.",
            "el": "Απαγορεύεται η στάθμευση ορισμένες ώρες.",
            "ru": "Парковка запрещена в определенное время."
        },
        "explanation": {
            "en": "This line depicts the side of the carriageway where parking is prohibited during specific times. Drivers must check nearby signs to see the exact hours when the restriction is in effect. Outside of these hours, parking may be permitted.",
            "uk": "Ця лінія позначає край проїзної частини, де паркування заборонено у визначений час. Водіям необхідно перевіряти дорожні знаки поруч, щоб дізнатися точний графік дії обмеження. У неробочий час обмеження паркування може бути дозволено.",
            "el": "Αυτή η γραμμή οριοθετεί την άκρη του οδοστρώματος όπου η στάθμευση απαγορεύεται σε συγκεκριμένες ώρες. Οι οδηγοί πρέπει να ελέγχουν τις κοντινές πινακίδες για το ακριβές ωράριο ισχύος. Εκτός αυτών των ωρών, η στάθμευση μπορεί να επιτρέπεται.",
            "ru": "Эта линия обозначает край проезжей части, вдоль которого парковка запрещена в определенные часы. Водителям следует проверять таблички рядом, чтобы узнать точное время действия ограничения. В остальное время парковка может быть разрешена."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "No parking or stopping here.",
            "uk": "Стоянка та зупинка заборонені.",
            "el": "Απαγορεύεται η στάση και στάθμευση.",
            "ru": "Стоянка и остановка запрещены."
        },
        "explanation": {
            "en": "These broken white lines depict the area of an exit or a bus stop. Parking and stopping are strictly prohibited in this zone to ensure that buses can pull in safely and exits remain clear for transitioning traffic.",
            "uk": "Ці переривчасті білі лінії позначають зону з’їзду або автобусної зупинки. Паркування та зупинка в цій зоні суворо заборонені, щоб автобуси могли безпечно заїжджати, а з’їзди залишалися вільними для руху транспорту.",
            "el": "Αυτές οι διακεκομμένες λευκές γραμμές οριοθετούν την περιοχή μιας εξόδου ή μιας στάσης λεωφορείου. Η στάθμευση και η στάση απαγορεύονται αυστηρά σε αυτή τη ζώνη, ώστε τα λεωφορεία να εισέρχονται με ασφάλεια και οι έξοδοι να παραμένουν ελεύθερες.",
            "ru": "Эти прерывистые белые линии обозначают зону съезда или автобусной остановки. Парковка и остановка в этой зоне строго запрещены, чтобы обеспечить безопасный заезд автобусов и беспрепятственный проезд транспорта на съездах."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "No crossing or overtaking.",
            "uk": "Перетин та обгін заборонено.",
            "el": "Απαγορεύεται προσπέρασμα ή υπέρβαση.",
            "ru": "Переезд и обгон запрещены."
        },
        "explanation": {
            "en": "These lines separate opposing traffic flows. Crossing or straddling these lines is strictly prohibited, and overtaking is not allowed. They are used in areas where visibility is limited or where it is extremely dangerous to move into the oncoming lane.",
            "uk": "Ці лінії розділяють зустрічні потоки транспорту. Перетинати їх або наїжджати на них суворо заборонено, а обгін недопустимий. Їх використовують на ділянках з обмеженою видимістю або там, де виїзд на зустрічну смугу є вкрай небезпечним.",
            "el": "Αυτές οι γραμμές διαχωρίζουν τις αντίθετες κατευθύνσεις κυκλοφορίας. Η υπέρβαση ή η οδήγηση πάνω σε αυτές απαγορεύεται αυστηρά, όπως και το προσπέρασμα. Χρησιμοποιούνται σε σημεία με περιορισμένη ορατότητα ή όπου η είσοδος στο αντίθετο ρεύμα είναι εξαιρετικά επικίνδυνη.",
            "ru": "Эти линии разделяют встречные потоки транспорта. Пересекать их или наезжать на них строго запрещено, а обгон запрещен. Разметка наносится в местах с ограниченной видимостью или там, где выезд на встречную полосу крайне опасен."
        },
    ...
    },
    {
        ...
        "explanation": {
            "en": "This solid white line is used to separate traffic lanes where safety is a priority. Crossing, straddling, or overtaking over this line is strictly prohibited. It is usually placed in areas with limited visibility or where changing lanes would create a high risk of accidents.",
            "uk": "Ця суцільна біла лінія розділяє смуги руху там, де безпека є пріоритетом. Перетинати її, наїжджати на неї або здійснювати обгін суворо заборонено. Зазвичай вона наноситься на ділянках з обмеженою видимістю або там, де зміна смуги створює високий ризик аварії.",
            "el": "Αυτή η συνεχή λευκή γραμμή χρησιμοποιείται για τον διαχωρισμό των λωρίδων κυκλοφορίας όπου η ασφάλεια είναι προτεραιότητα. Η υπέρβαση, η οδήγηση πάνω στη γραμμή ή το προσπέρασμα απαγορεύονται αυστηρά. Τοποθετείται σε σημεία με περιορισμένη ορατότητα ή επικινδυνότητα.",
            "ru": "Эта сплошная белая линия разделяет полосы движения в местах, где важна повышенная осторожность. Пересекать её, заезжать на неё или совершать обгон строго запрещено. Как правило, она встречается на участках с плохой видимостью или там, где маневры могут привести к ДТП."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "No parking, stopping, or overtaking.",
            "uk": "Заборонено паркування, зупинку та обгін.",
            "el": "Απαγορεύεται στάθμευση, στάση ή προσπέρασμα.",
            "ru": "Запрещены парковка, остановка и обгон."
        },
        "explanation": {
            "en": "These zigzag lines are placed near pedestrian crossings. Parking, waiting, or overtaking within this area is strictly prohibited at all times. This ensures that both pedestrians and approaching drivers have a clear, unobstructed view of each other to prevent accidents.",
            "uk": "Ці зигзагоподібні лінії наносяться біля пішохідних переходів. Паркування, очікування або обгін у цій зоні суворо заборонені в будь-який час. Це забезпечує пішоходам і водіям чіткий огляд один одного для запобігання нещасним випадкам.",
            "el": "Αυτές οι ζικ-ζακ γραμμές τοποθετούνται κοντά σε διαβάσεις πεζών. Η στάθμευση, η αναμονή ή το προσπέρασμα σε αυτή την περιοχή απαγορεύονται αυστηρά ανά πάσα στιγμή. Αυτό εξασφαλίζει ότι τόσο οι πεζοί όσο και οι οδηγοί έχουν πλήρη ορατότητα μεταξύ τους.",
            "ru": "Эти зигзагообразные линии наносятся вблизи пешеходных переходов. Парковка, ожидание или обгон в этой зоне строго запрещены в любое время. Разметка гарантирует, что пешеходы и водители будут хорошо видеть друг друга, что критически важно для безопасности."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "Overtake only if broken line is near you.",
            "uk": "Обгін дозволено лише з боку переривчастої.",
            "el": "Προσπέρασμα μόνο από τη διακεκομμένη πλευρά.",
            "ru": "Обгон разрешен только со стороны прерывистой."
        },
        "explanation": {
            "en": "This marking features a solid line and a broken line together. If the broken line is on your side, you may cross it to overtake when safe. If the solid line is on your side, crossing and overtaking are strictly prohibited.",
            "uk": "Ця розмітка складається з суцільної та переривчастої ліній. Якщо переривчаста лінія знаходиться з вашого боку, ви можете перетинати її для обгону, коли це безпечно. Якщо ж з вашого боку суцільна лінія — перетин та обгін суворо заборонені.",
            "el": "Αυτή η διαγράμμιση αποτελείται από μία συνεχή και μία διακεκομμένη γραμμή. Εάν η διακεκομμένη γραμμή είναι από την πλευρά σας, μπορείτε να την υπερβείτε για προσπέρασμα αν είναι ασφαλές. Εάν η συνεχής γραμμή είναι από την πλευρά σας, η υπέρβαση απαγορεύεται.",
            "ru": "Эта разметка сочетает в себе сплошную и прерывистую линии. Если прерывистая линия находится ближе к вам, вы можете пересекать её для обгона, если это интересно. Если же с вашей стороны сплошная линия — пересечение и обгон категорически запрещены."
        },
    ...
    },
    {
        ...
        "hint": {
            "en": "May cross to overtake safely.",
            "uk": "Можна перетинати для безпечного обгону.",
            "el": "Επιτρέπεται η υπέρβαση για προσπέρασμα.",
            "ru": "Можно пересекать для безопасного обгона."
        },
        "explanation": {
            "en": "This standard broken white line is used to divide lanes of traffic. Drivers are permitted to cross this line to change lanes or perform overtaking maneuvers, provided the road ahead is clear and it is safe to do so without endangering other road users.",
            "uk": "Ця стандартна переривчаста біла лінія використовується для розділення смуг руху. Водіям дозволяється перетинати цю лінію для зміни смуги або здійснення обгону, за умови, що дорога попереду вільна і маневр є безпечним для інших учасників руху.",
            "el": "Αυτή η τυπική διακεκομμένη λευκή γραμμή χρησιμοποιείται για τον διαχωρισμό των λωρίδων κυκλοφορίας. Οι οδηγοί επιτρέπεται να τη διασχίζουν για αλλαγή λωρίδας ή προσπέρασμα, υπό την προϋπόθεση ότι ο δρόμος μπροστά είναι ελεύθερος και ο ελιγμός είναι ασφαλής.",
            "ru": "Эта стандартная прерывистая белая линия разделяет полосы движения. Водителям разрешается пересекать её для смены полосы или совершения обгона при условии, что дорога впереди свободна и маневр не создаст опасности для других участников движения."
        },
